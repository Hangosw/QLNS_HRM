...
@section('content')
    <div class="page-header">
        <h1>Văn thư đi</h1>
        <p>Danh sách văn bản, công văn đi</p>
    </div>
    ...
    <div class="card">
        <div class="table-container">
            <table class="table" id="outgoingTable">
                <thead>
                    <tr>
        ...
        <script>
            $(document).ready(function () {
                $('#outgoingTable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: '{{ route('documents.outgoing.data') }}',
                    columns: [
                        {
                            data: null,
                        ...
                        { data: 'phong_ban.Ten', defaultContent: '-' },
                        {
                            data: 'trang_thai',
                            render: function (data) {
                                if (data === 'da_gui') return '<span class="badge badge-success">Đã gửi</span>';
                                if (data === 'dang_ky') return '<span class="badge badge-info">Vừa đăng ký</span>';
